export const translations = {
    en: {
        ...
        legendTitle: 'Scoring Legend (-13.5 to 18.25)',
    ...
    bg: {
        ...
        criteria5Desc: " Windy: в слоя Wind, постави курсора на мястото на спота (Raches). Ако след 13:00 вятърът рязко се усилва (примерно от 6 до 15 възела), това е ТЕРМИЧНО ЗАСИЛВАНЕ.",
        pointsSuffix: "т.",
        tempDiffHigh: "Висока",
        tempDiffMedium: "Средна",
        tempDiffLow: "Ниска",
        tempDiffVeryLow: "Много ниска",
        legendTitle: 'Легенда на Точкуването (от -13.5 до 18.25)',
