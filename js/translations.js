export const translations = {
    en: {
        ...
        legendWindDir: '<b>Wind Direction:</b> +2 pts for NE-E (ideal), -2 pts for E-SE & N-NE, -4 for SE-S-SW, -8 for W-NW (bad).',
    ...
    bg: {
        ...
        legendWindDir: '<b>Посока на Вятъра:</b> +2 т. за СИ-И (идеална), -2 т. за И-ЮИ и С-СИ, -4 т. за ЮИ-Ю-ЮЗ, -8 т. за З-СЗ (лоша).',
