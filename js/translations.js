export const translations = {
    en: {
        ...
        windDirSE_Ideal: "Southeast (Ideal)",
        windDirE_Acceptable: "East (Acceptable)",
        windDirS_SSE_Acceptable: "South-Southeast (Acceptable)",
        windDirW_SW_NW_Bad: "West, Southwest, Northwest (Bad)",
        windDirNeutral: "Neutral",
        ...
        legendTitle: 'Scoring Legend (-14.5 to 17.25)',
        legendIntro: 'The final score is a sum of points from the following criteria:',
        legendCloudCover: '<b>Cloud Cover:</b> from +5 pts (clear) to -3 pts (cloudy).',
        ...
        legendWindDir: '<b>Wind Direction:</b> +3 pts for SE (ideal), +1.5 pts for E & S/SSE, 0 for neutral, -8 for W/SW/NW (bad).',
    ...
    bg: {
        ...
        windDirSE_Ideal: "Югоизточен (Идеална)",
        windDirE_Acceptable: "Източен (Приемлива)",
        windDirS_SSE_Acceptable: "Юго-югоизточен (Приемлива)",
        windDirW_SW_NW_Bad: "Западен, Югозападен, Северозападен (Лоша)",
        windDirNeutral: "Неутрална",
        ...
        legendTitle: 'Легенда на Точкуването (от -14.5 до 17.25)',
        ...
        legendWindDir: '<b>Посока на Вятъра:</b> +3 т. за ЮИ (идеална), +1.5 т. за И и ЮЮИ, 0 за неутрална, -8 за З/ЮЗ/СЗ (лоша).',
